...
resp200
  ...
  -> Response
resp200 ct =
  responseLBS status200 [("Content-Type", renderContentType ct)]
...
resp404
  ...
  -> Response
resp404 ct =
  responseLBS status404 [("Content-Type", renderContentType ct)]
...
resp400
  ...
  -> Response
resp400 ct =
  responseLBS status400 [("Content-Type", renderContentType ct)]
...
mkErrorResponse e =
  case e of
    StringEmpty -> resp400 PlainText "Bad Request"
...
mkRequest r =
  ...
  case (requestMethod r, pathInfo r) of
    (methodPost, [t, "add"]) -> mkAddRequest t <$> strictRequestBody r
    (methodGet, [t, "view"]) -> pure $ mkViewRequest t
    (methodGet, ["list"]) -> pure mkListRequest
...
handleRequest r =
  case r of
    AddRq t c -> Right $ resp200 PlainText "Not implemented yet"
    ViewRq t -> Right $ resp200 PlainText "Not implemented yet"
